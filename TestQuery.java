...
public class TestQuery {
	public static void main(String args[]) throws IOException {
		...
		File file = new File("/home/cssumit/Desktop/IRE_MAJOR/Test/features");
		if (file.exists()) {
			file.delete();
		}
		FileInputStream f1 = null;
        BufferedReader reader = null;
        File file1 = new File("/home/cssumit/Desktop/IRE_MAJOR/Test/output");
        File file2 = new File("/home/cssumit/Desktop/IRE_MAJOR/Test/query");
        ...
        try {
            f1 = new FileInputStream("/home/cssumit/Documents/nfs/test");
