...
public class features {
	public void calc_features(HashMap hm_nonper,HashMap hm, HashMap hm_dom, String uid, String qid)
			throws IOException {
		
		File file1 = new File("/home/swapna/sem6/ire/project/features");
		...
		for(Object key:hm.keySet())
		{
			...
			String s = hm.get(key) + " qid:" + qid + " " + "1:" +hm_nonper.get(key)+" ";
			//fnum=fnum+1;
		...
		{
			System.out.print(doc_list.get(i)+" ");
		}
		*/
		...
		for (int i = 0; i <6; i++) {
			...
			FileInputStream f1 = new FileInputStream("/home/swapna/sem6/ire/project/C" + i);
